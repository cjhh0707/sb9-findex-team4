-- 0. 시퀀스 (Hibernate AUTO 전략용)
CREATE SEQUENCE IF NOT EXISTS index_info_seq START 1 INCREMENT 50;
CREATE SEQUENCE IF NOT EXISTS index_data_seq START 1 INCREMENT 50;
CREATE SEQUENCE IF NOT EXISTS integration_seq START 1 INCREMENT 50;
CREATE SEQUENCE IF NOT EXISTS auto_integration_seq START 1 INCREMENT 50;
